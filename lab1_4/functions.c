...
char *create_output_file(char *input_file_name) {
    ...
    char *output_file_name = malloc(out_length * 2);
...
void without_arabic_normal_mode(char *input_file_name) {
...
void liters_to_16CC_normal_mode(char *input_file_name) {
    FILE *input_file = NULL;
    FILE *output_file = NULL;
    if (!(output_file = fopen(create_output_file(input_file_name), "w"))) {
        printf("Error!");
...
void counter_latin_normal_mode(char* input_file_name){
    FILE *input_file = NULL;
    FILE *output_file = NULL;
    if (!(output_file = fopen(create_output_file(input_file_name), "w"))) {
        printf("Error!");
...
void counter_not_latin_normal_mode(char* input_file_name){
    FILE *input_file = NULL;
    FILE *output_file = NULL;
    if (!(output_file = fopen(create_output_file(input_file_name), "w"))) {
        printf("Error!");
